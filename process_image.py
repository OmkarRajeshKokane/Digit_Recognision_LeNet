...
import os
model_path=r'E:\project\rasika_samiksha_project\env_for_Gopal_Sir_code\RealTime-DigitRecognition-master\cnn_model\digit_classifier.h5'
if (os.path.exists(model_path)):
    # loading pre trained model
    print("found model path")
    model = load_model(model_path)
#model = tf.keras.models.load_model('E:\project\rasika_samiksha_project\RealTime-DigitRecognition-master\cnn_model\digit_classifier.h5', compile=False)
else:
    print("module path not found")
# Save the model again using the latest version
#model.save('E:\project\rasika_samiksha_project\RealTime-DigitRecognition-master\cnn_model\digit_classifier_new.h5')
